# Single Cell Spatial Platform 用户手册

> 文档用途：帮助普通用户快速了解并使用 Single Cell Spatial Platform 的核心页面、可视化分析功能与上传流程。  
> 文档更新时间：2026-03-27  
...
Single Cell Spatial Platform 是一个面向空间转录组、单细胞与相关多模态数据的可视化与结果交付平台。当前网站主要包含以下入口：
...
![About 页面截图](E:/xjh/project/PM/PM-System-Beta/img/about-page.png)
...
![Analyse 页面截图](E:/xjh/project/PM/PM-System-Beta/img/platform-page.png)
...
![UploadData 页面截图](E:/xjh/project/PM/PM-System-Beta/img/upload-page.png)
...
![References 页面截图](E:/xjh/project/PM/PM-System-Beta/img/references-page.png)
...
- 官方网站：`http://www.single-cell-spatial.com`
