# Single Cell Spatial Platform User Manual

> Purpose: This document helps end users understand and operate the core pages, visualization features, and upload workflow of the Single Cell Spatial Platform.  
...
Single Cell Spatial Platform is a web platform for visualization, exploration, and result delivery of spatial transcriptomics, single-cell, and related multimodal datasets. The website currently includes the following main sections:
...
- Website: `http://www.single-cell-spatial.com`
